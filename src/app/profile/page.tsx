...
export default function Profile() {
    ...
    const handleFieldCancel = (fieldName: string) => {
        if (profile && originalProfile) {
            setProfile({ ...profile, [fieldName]: (originalProfile as any)[fieldName] });
        }
                                ...
                                <div className="flex-1">
                                    ...
                                    {isFieldEditing("username") ? (
                                        <div className="flex items-center gap-2 mt-1">
                                            ...
                                            />
                                            <button
                                                onClick={() => setEditingFields(prev => { const newSet = new Set(prev); newSet.delete("username"); return newSet; })}
                                ...
                                <div className="flex-1">
                                    ...
                                    {isFieldEditing("phoneNo") ? (
                                        <div className="flex items-center gap-2 mt-1">
                                            ...
                                            />
                                            <button
                                                onClick={() => setEditingFields(prev => { const newSet = new Set(prev); newSet.delete("phoneNo"); return newSet; })}
                                                className="p-2 text-green-600 hover:text-green-700"
                                            >
                                                <Check className="w-4 h-4" />
                                            </button>
                                ...
                                <div className="flex-1">
                                    ...
                                    {isFieldEditing("hostelName") ? (
                                        <div className="flex items-center gap-2 mt-1">
                                            ...
                                            />
                                            <button
                                                onClick={() => setEditingFields(prev => { const newSet = new Set(prev); newSet.delete("hostelName"); return newSet; })}
                                                className="p-2 text-green-600 hover:text-green-700"
                                            >
                                                <Check className="w-4 h-4" />
                                            </button>
                                ...
                                <div className="flex-1">
                                    ...
                                    {isFieldEditing("roomNumber") ? (
                                        <div className="flex items-center gap-2 mt-1">
                                            ...
                                            />
                                            <button
                                                onClick={() => setEditingFields(prev => { const newSet = new Set(prev); newSet.delete("roomNumber"); return newSet; })}
                                                className="p-2 text-green-600 hover:text-green-700"
                                            >
                                                <Check className="w-4 h-4" />
                                            </button>
                                ...
                                <div className="flex-1">
                                    ...
                                    {isFieldEditing("location") ? (
                                        <div className="flex items-center gap-2 mt-1">
                                            ...
                                            />
                                            <button
                                                onClick={() => setEditingFields(prev => { const newSet = new Set(prev); newSet.delete("location"); return newSet; })}
                                                className="p-2 text-green-600 hover:text-green-700"
                                            >
                                                <Check className="w-4 h-4" />
                                            </button>
                        ...
                        {selectedFile ? selectedFile.name : "Click to select an image"}
                            ...
                            {previewUrl && (
                                <div className="mb-4">
                                    ...
                                    <div className="w-24 h-24 rounded-full overflow-hidden bg-gray-100 mx-auto border-2 border-blue-200">
                                        <img
                                            src={previewUrl}
                                            alt="Preview"
                                            className="w-full h-full object-cover"
